...
Computer Science, University of Florida (B.S./M.S.). Solo founder building and
**forward-deploying** AI systems into small and mid-sized businesses — the messy,
real-world integration work between "the model can do this" and "it's running in
production for a paying customer."

**What I actually do:** discovery → architecture → deployment → owning the outcome.
Bilingual (EN/ES) AI voice systems, sales-ops automation, and the CRM/data plumbing
...
### T-shaped stack
**Deep:** applied AI deployment (LLM orchestration, voice, integration).
